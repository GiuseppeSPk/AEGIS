...
Maps AEGIS attack results to OWASP LLM Top 10 2025 categories and generates
...
from aegis.compliance.models import (
    ComplianceFinding,
    ComplianceStatus,
    OWASPCategory,
    OWASPVulnerability,
...
OWASP_VULNERABILITIES: dict[OWASPCategory, OWASPVulnerability] = {
    OWASPCategory.LLM01: OWASPVulnerability(
        ...
        remediation=(
            ...
            "6. Regular red team testing with AEGIS or similar tools"
        ),
        references=[

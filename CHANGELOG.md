...
## [0.2.2] - 2026-01-14 (Application Ready)
...
### Fixed
- **License Switch**: Project license set to **AGPL-3.0** to ensure contributions are shared back. Update reflected in `README.md`, `pyproject.toml`, `LICENSE`, and `verity/__init__.py`.
